    ...
    <Container maxWidth={false} className="main-page-header">
      <Grid container spacing={4}>
        <Grid item container xs={6} lg={4} spacing={3}>
          <Grid item>
            <Typography variant="h5" style={{ color: '#6E7A8A' }}>
              <b>Action {activePage}</b>
            </Typography>
          </Grid>
          <Grid item>
            {' '}
        ...
        >
          <Grid item container spacing={2} xs={6}>
            <Grid item>
              <Button onClick={onAddIndicatorClick} icon={<AddIcon />}>
                Add Challenge
              </Button>
            </Grid>
            <Grid item xs={6}>
          ...
          <Grid item xs={6}>
            ...
            {
                            reference && <DownloadOptionsMenu onDownloadExcel={onDownloadExcel} onDownloadPDF={onDownloadPDF}  reference={reference}
