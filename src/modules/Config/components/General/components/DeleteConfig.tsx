            ...
            <div>
                <Button onClick={() => {
                    confirm({
                        ...
                        message: i18n.t('Are you sure you want to delete this configuration?'),
                        onCancel: () => {
                        },
                        onConfirm: onDelete,
                        confirmButtonText: i18n.t('Delete'),
                    })
                }} destructive>{i18n.t('Delete configuration')}</Button>
            </div>
            <span>{i18n.t('Make sure there are no data associated with this configuration before deleting it.')}</span>
        </div>
    )
}
