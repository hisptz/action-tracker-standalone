...
export function SaveArea() {
	...
	return (
		...
		>
			<ButtonStrip>
				<Button
					dataTest="reset-config-button"
					disabled={!form.formState.isDirty}
				>
					{i18n.t("Reset")}
				</Button>
				<Button
					dataTest="save-config-button"
					loading={loading || uploadingMetadata}
					onClick={() => form.handleSubmit(onSave)()}
					primary
					disabled={
						!form.formState.isDirty || loading || uploadingMetadata
					}
				>
					{uploadingMetadata
						? i18n.t("Updating metadata...")
						: loading
							? i18n.t("Saving...")
							: i18n.t("Save changes")}
				</Button>
