...
function OptionForm({hide, onClose, onAdd, selected, valueType}: {
    hide: boolean;
    onClose: () => void;
    selected?: string[]
                                    ...
                                    <TableRow>
                                        <td style={{margin: 0, padding: 0}} colSpan={3}>
                                            <div className={classes['table-body']}>
                                                <table style={{margin: 0, padding: 0, borderCollapse: "collapse"}}
                                                       className="w-100">
                                                    <col style={{width: "40%"}}/>
                                                    <col style={{width: "40%"}}/>
                                                    <col style={{width: "20%"}}/>
...
export function OptionSetForm({hide, onClose, onSave, valueType}: OptionSetFormProps) {
    const {saving, saveOptionSet} = useManageOptionSet();
            ...
            <ModalContent>
                <FormProvider {...form}>
                    <form className="column gap-16">
                        <RHFTextInputField required validations={{required: i18n.t("Name is required")}} name={`name`}
                                           label={i18n.t("Name")}/>
                        <RHFTextInputField required validations={{required: i18n.t("Code is required")}} name={`code`}
                                           label={i18n.t("Code")}/>
